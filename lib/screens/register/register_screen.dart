                        ...
                        children: [
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: generalController
                                        ...
                                        : ClipOval(
                                            child: Image.file(
                                                generalController.imageRegister.value,
                                                width: 180,
                                                height: 180,
                                                fit: BoxFit.cover),
                                          ),
                          ...
                          TextField(
                            ...
                            controller: TextEditingController(
                              text:
                                  generalController.dob.value.year >= DateTime.now().year
                                      ? "Ngày sinh"
                                      : DateFormat('yyyy-MM-dd')
                                          .format(generalController.dob.value),
                            ),
                            decoration: InputDecoration(
                              border: const OutlineInputBorder(
                                  borderRadius:
                              ...
                              focusedBorder: OutlineInputBorder(
                                  ...
                                  borderRadius:
                                      const BorderRadius.all(Radius.circular(10))),
                              errorText: generalController.emptyDOB.value
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                ...
                                String result = await userController.verifyEmail(
                                    ...
                                    textBioController.text, 1);
                                if (result == "") {
                                  Get.to(() => VerifyAccountScreen(emailRegister: textEmailController.text),
