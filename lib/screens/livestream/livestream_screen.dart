...
class _LivestreamScreenState extends State<LivestreamScreen> {
  ...
  Future<void> initializeAgora() async {
    ...
    await _engine.joinChannel(matchController.matchDetail.value.tokenLivestream,
        "MATCH_" + matchController.matchDetail.value.id.toString(), userController.user.value.username, userController.user.value.id!);
  }
