...
class TournamentAPI {
  ...
  static Future<int> getListTournament(String name) async {
    final tournamentController = GetX.Get.put(TournamentController());
    int rs = 0;
    try {
      final response = await http.get(Uri.parse("https://afootballleague.ddns.net/api/v1/tournaments?page-offset=1&limit=20"),
      ...
      if(response.statusCode == 200) {
        ...
        tournamentController.countListTournament.value = listTournament.countList!;
      }
