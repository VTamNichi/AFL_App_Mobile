...
class MatchDetailController extends GetxController {
  ...
  HubConnection hubConnection =
          HubConnectionBuilder().withUrl("https://afootballleague.ddns.net/chat").build();
  ...
  void _handlerReceiveComment(List<Object>? args) {
    ...
    if(user.length > 20){
      ...
      listCommentLive.add(UserComment(
        username: username,
        avatar: avatar,
        room: comment
      ));
  ...
  void _handlerMatchDetail(List<Object>? args) async {
    await teamInMachController.getListTeamInMatch(tournamentController.tournamentDetail.value.id!);
